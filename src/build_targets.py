...
d=d[d.n_tot>=300].reset_index(drop=True)
...
d.to_parquet('data/derived/target_cards.parquet',index=False)
...
lines=["# 2026 target cards (through 2026-08-16) — repertoire lever, precedent-valued\n",
...
open('docs/targets_2026.md','w').write('\n'.join(lines))

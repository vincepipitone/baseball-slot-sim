...
const cols=[['name','Pitcher','l'],['team','Tm','l'],['age','Age'],['role','Role','l'],['ip','IP'],['slot','Slot°'],['eff4','4S eff'],['cls','Class','l'],['stuff','Stuff+'],['own','Own'],['loc','Loc+'],['act','Actionable'],['mixb','Mix'],['best','Best add','l'],['bpstf','Prec Stf+'],['addact','Add gain'],['dropb','Drop'],['projact','Proj Stf+'],['opp','Drift'],['gap','Regress'],['ev','Add ΣEV'],['bp','P(add)'],['coors','Coors'],['pool','Pool']];
...
<div class="stats">
<div class="stat"><div class="v">+2.5 / +2.5</div><div class="l">2026 Stuff+ / Pitching+ excess of the as-of-2025 ACTIONABLE top-40 vs matched controls (n=23; top-80 +2.1 / +1.6)</div></div>
